    ...
    <div>
      ...
      <div className="p-5 bg-[#FCF8F4]">
        ...
        <div className="flex flex-wrap gap-5 px-4 sm:px-32 mt-24 mb-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center py-20 sm:py-0">
            <div className="w-full sm:w-1/2">
              <h1 className="text-4xl sm:text-5xl font-bold mb-5">Individual Therapy</h1>
            </div>
            <div className="w-full sm:w-1/2">
              <p className="text-lg font-poppins mb-4">
                Our individual therapy sessions provide a safe, confidential space for personal growth and healing. We work together to address your specific concerns and develop effective coping strategies.
              </p>
              <p className="text-lg font-poppins">
                Through personalized treatment plans and evidence-based approaches, we help you achieve meaningful progress in your mental health journey.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10 text-center py-12 sm:py-16">
          <h1 className="text-3xl sm:text-4xl font-semibold mb-8">Individual Therapy Method</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 justify-center mt-8 p-10">
            <div className="bg-gradient-to-r from-teal-700 to-teal-400 p-6 rounded-3xl text-center text-white">
              <img src="src/assets/online counselling/007-psychologist.png" alt="Psychoanalytic Therapy" className="w-24 h-24 mx-auto mb-4" />
              <h2 className="text-2xl font-semibold mb-2">Psychoanalytic Therapy</h2>
              <p className="text-lg font-poppins">Explore deep-seated patterns and unconscious influences to gain profound self-understanding and emotional healing.</p>
            </div>
            <div className="bg-white p-5 rounded-xl text-center">
              <img src="src/assets/online counselling/Group (6).png" alt="Mindfulness Based Therapy" className="w-24 h-24 mx-auto mb-4" />
              <h2 className="text-2xl font-semibold mb-2">Mindfulness Based Therapy</h2>
              <p className="text-lg font-poppins">Learn practical techniques to stay present, manage stress, and develop greater emotional awareness.</p>
            </div>
            <div className="bg-white p-5 rounded-xl text-center">
              <img src="src/assets/online counselling/022-inner dialogue.png" alt="Cognitive Behavioral Therapy" className="w-24 h-24 mx-auto mb-4" />
              <h2 className="text-2xl font-semibold mb-2">Cognitive Behavioral Therapy</h2>
              <p className="text-lg font-poppins">Identify and transform challenging thought patterns to improve emotional well-being and daily functioning.</p>
            </div>
            <div className="bg-gradient-to-r from-teal-700 to-teal-400 p-6 rounded-3xl text-center text-white">
              <img src="src/assets/online counselling/Group (7).png" alt="Humanistic Therapy" className="w-24 h-24 mx-auto mb-4" />
              <h2 className="text-2xl font-semibold mb-2">Humanistic Therapy</h2>
              <p className="text-lg font-poppins">Discover your inner potential through person-centered approaches that emphasize self-growth and awareness.</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex relative" style={{ backgroundImage: `url(${frameImage})` }}>
          ...
          <div className="text-white flex flex-col items-center sm:items-start sm:w-3/4 p-6">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">Introduction to Experienced Consulting</h1>

            <div className="w-full sm:w-3/4 mb-8">
              {/* Professional Growth Section */}
              <div className="w-full flex mb-8 sm:mb-4 p-3 rounded-xl">
                <img src="src/assets/Vector.png" alt="Professional Growth" className="w-[84px] h-[84px]" />
                <div className="pl-5 flex flex-col justify-center">
                  <h2 className="text-xl font-semibold mb-3">Professional Growth</h2>
                  <p className="text-sm font-poppins">Enhance your personal and professional development through expert guidance.</p>
                </div>
              </div>

              {/* Reduced Burnout Section */}
              <div className="w-full flex p-3 rounded-xl">
                <img src="src/assets/Vector (1).png" alt="Reduced Burnout" className="w-[84px] h-[84px] object-cover" />
                <div className="pl-5 flex flex-col justify-center">
                  <h2 className="text-xl font-semibold mb-3">Reduced Burnout</h2>
                  <p className="text-sm font-poppins">Learn effective stress management techniques to maintain work-life balance and emotional well-being.</p>
                </div>
              </div>
            </div>
          </div>
