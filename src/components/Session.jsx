...
const Session = () => {
  ...
  return (
    <div className='bg-[#FCF8F4]'>
      <nav className="flex w-full p-8 sm:p-16 lg:p-28 bg-cover"
        ...
        <div className="flex max-w-screen-2xl px-4 sm:px-8 md:px-16 lg:px-32">
          ...
          <div>
            <h1 className="text-white text-4xl sm:text-5xl lg:text-6xl font-semibold p-4">Professional Online Counseling Support</h1>
      ...
      <div className="max-w-screen-xl mx-auto p-6">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-6 text-black p-20">Our Professional Counselor</h1>
          <div className="flex flex-col items-center bg-gradient-to-r from-[#007D6E] to-[#5EB47C] rounded-xl w-full max-w-md mx-auto p-6">
            <img src='/src/assets/book seassion.png' alt="Dr. Micheal Chen" className="w-28 h-32 rounded-full mb-6" />
            <h2 className="text-2xl font-semibold text-white">Dr. Micheal Chen</h2>
            <p className="text-lg text-white mb-6">Relationship Counselor</p>
            <Button onClick={handleclick} className="bg-[#EC744A] text-white py-3 px-6 rounded-full">Book Session</Button>
          </div>
        </div>

        {/* How It Works Section */}
        <div className="mb-16">
          <h1 className="text-2xl font-semibold text-center mb-8">How it Works</h1>
          <div className="flex flex-wrap justify-center gap-6">
            <div className="flex flex-col items-center bg-white p-6 max-w-xs sm:max-w-sm lg:max-w-xs">
              <img src='/src/assets/contact.png' alt="Create Account" className="w-16 h-16 mb-4" />
            ...
            <div className="flex flex-col items-center bg-white p-6 max-w-xs sm:max-w-sm lg:max-w-xs">
              <img src='/src/assets/video call.png' alt="Start Session" className="w-16 h-16 mb-4" />
              <h2 className="text-lg font-semibold mb-2">Start Session</h2>
              <p className="text-sm text-center text-gray-600 font-poppins">Start your session at the scheduled time and enjoy a seamless experience.</p>
            </div>
          </div>
        </div>
  ...
  Choose Video Call
          ...
          <div className="flex flex-col items-center bg-gradient-to-r from-[#007D6E] to-[#5EB47C] p-6 rounded-xl shadow-lg w-full sm:max-w-xs lg:w-1/3 relative">
            <img src='src/assets/Clip path group.png' alt="Phone Call" className="w-16 h-16 mb-4" />
            <h1 className="text-xl font-semibold text-white mb-2">Phone Call</h1>
            <p className="text-sm pb-8 text-center text-white mb-4 font-poppins">Voice-only sessions for more privacy</p>
            <Button className="bg-[#EC744A] text-white py-3 px-6 sm:py-3 sm:px-8 md:py-4 md:px-10 text-sm sm:text-base md:text-lg rounded-full w-full sm:w-auto">
  Choose Phone Call
</Button>
          </div>
          ...
          {/* Chat Support */}
          <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-lg w-full sm:max-w-xs lg:w-1/3">
            <img src='src/assets/online.png' alt="Chat Support" className="w-16 h-16 mb-4" />
            <h1 className="text-xl font-semibold mb-2">Chat Support</h1>
            <p className="text-sm pb-5 text-center text-gray-600 mb-4 font-poppins">Text-based counseling with quick responses</p>
           <Button className="bg-[#EC744A] text-white py-3 px-6 sm:py-3 sm:px-8 md:py-4 md:px-10 text-sm sm:text-base md:text-lg rounded-full w-full sm:w-auto">
  Choose Chat
</Button>
          </div>
