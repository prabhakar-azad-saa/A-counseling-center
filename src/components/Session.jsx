        ...
        <div className=" justify-center  p-8 sm:p-16 lg:p-20">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-lg w-full sm:max-w-xs lg:w-1/3">
              ...
              <Button
                onClick={() => handleclick("zoomMeeting")}
                className="bg-[#EC744A] text-white py-3 px-6 sm:py-3 sm:px-8 md:py-4 md:px-10 text-sm sm:text-base md:text-lg rounded-full w-full sm:w-auto"
              >
                Choose Video Call
              </Button>
            </div>
